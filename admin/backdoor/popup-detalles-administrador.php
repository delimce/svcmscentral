...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
  <td>DELIMCE CAMBIAR A DATOS NORMALES EN LOS TD, NO BOXES DE FORM.! BORRAR ESTE MENSAJE</td>
 </tr>
 <tr>
  ...
  <table width="100%" border="0" cellspacing="3" cellpadding="0">
   <tr>
     ...
     <td><?php echo $datos->combo_db("cuenta","select id,titulo from cuenta ","titulo","id",false,$data['cuenta_id']); ?></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td><input name="pass" onClick="this.value='';" type="text" class="form-box" id="pass" value="<?=$data['pass']?>" size="30">
   ...
   <tr>
     ...
     <td><input name="pass2" onClick="this.value='';" type="text" class="form-box" id="pass2" value="<?=$data['pass']?>" size="30"></td>
   </tr>
   <tr>
    <td>&nbsp;</td>
    <td align="right">&nbsp;
