...
*/
		...
		////////////////////
					...
					$form->update_data("r","_","cont_subcategoria",$_POST,"id = '{$_REQUEST['id']}'");


					?>
                      <script language="JavaScript" type="text/JavaScript">
					 		window.opener.abrir_cat('<?=$_REQUEST['cati'] ?>','1');
							window.opener.abrir_cat('<?=$_REQUEST['cati'] ?>','1');
						   window.close();
					   </script>
                    <?
			 ...
			 $datos = $form->simple_db("select cat_id,id,nombre,imagen,descrip,users from cont_subcategoria where id = {$_REQUEST['id']}");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td class="td-titulo-popup"> Editar sub categor&iacute;a </td>
 </tr>
 <tr>
  <td>&nbsp;</td>
 </tr>
   ...
   <table width="100%" border="0" cellspacing="4" cellpadding="0">
    ...
    <tr>
     ...
     <td><input name="imagen" type="file" class="form-box" id="imagen">
      ...
      <input name="cati" type="hidden" id="cati" value="<?=$datos['cat_id'] ?>">      <?php echo '<span class="span-agregar">'.$datos['imagen'].'</span>'; ?></td>
    </tr>
