 ...
 <tr>
  <td>
   <table width="100%" border="0" cellspacing="4" cellpadding="0">
    ...
    <tr>
      <td class="td-form-title"><strong>Longitud (Caracteres)</strong>:<img src="../icon/icon-info.gif" width="16" height="16" align="absmiddle" title="Longitud del campo de texto en caracteres."></td>
      <td>
