...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
      <td><table width="91%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
       <tr>
        <td class="td-texto1"><p>Llene los campos del formulario para agregar/editar su contacto.</p>
                        <p>Proceda con cautela.</p>
        </td>
       </tr>
       <tr>
        <td>&nbsp;</td>
...
<!--aqui va la accion-->
	...
	if(isset($_POST['Submit'])){
				...
				*/
				...
				$datos->javaviso("Contacto editado con exito","index.php");
	...
	?>
	  ...
	  <form action="" method="post" name="form1" onSubmit="YY_checkform('form1','r_nombre','#q','0','Debe escribir un  Nombre','r_email','S','2','El Email debe ser Válido');return document.MM_returnValue">
			        ...
			        El tama&ntilde;o m&aacute;ximo de
									  ...
									  <td colspan="2"><iframe id="archivos" src="archivos.php" height="400" width="90%" frameborder="0"></iframe></td>
						  </tr>
									<tr>
