...
class image extends  database {
	...
	function __construct($path) {     //costructor
	...
	function redimensionar($ruta, $anchura, $altura, $calidad,$porcentual=true) {
     /*
		...
		*/
		...
		if($this->datos[2]==2) imagejpeg($imagen,$ruta,100);
                else if($this->datos[2]==1) imagegif($imagen,$ruta,100);
                else imagejpeg($imagen,$ruta,100);
