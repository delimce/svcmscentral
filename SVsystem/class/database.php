...
class database {
 ...
 //**********************************************************************Atributos de la clase
  ...
  public $nreg;    //// cantidad de registros insertados
 ...
 ///metodo para cerrar la conexion con la base de datos
  ...
  //utilizado ideal para sentencias insert, update, delete etc
   ...
   {// ejecuta un query o devuelve un error
     $this->result = @mysql_query($sql,$this->dbc) or die('<font color=#FF0000> error en query: </font>'. mysql_error());
...
// tabla, campos, valores y boqueo true o false (opcional)
     ...
     for($i=0;$i<count($valores2);$i++){
       ...
       $valor = mysql_real_escape_string($valores2[$i]);  //// me aseguro de que no se inserten valores invalidos
       $valores2[$i] = "'$valor'";
