	...
	$.jstree.plugin("ui", {
		...
		_fn : { 
			...
			hover_node : function (obj) {
				...
				//this.data.ui.hovered = obj.children('span').children("a").addClass("jstree-hovered").parent();
				this.data.ui.hovered = obj.addClass("jstree-hovered");
				this.__callback({ "obj" : obj });
			},
			dehover_node : function () {
				...
				p = obj.removeClass("jstree-hovered");
