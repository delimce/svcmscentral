...
$tool->autoconexion();
	...
	if(isset($_POST['Submit'])){
					 ...
					 $data = $tool->simple_db("select url_empresa from preferencias");   
					$producto = $_POST['producto'];
		
				   $email_send     = $_POST['email3'];
				   $nombre_email   = $_POST['nombre'];
				   $email_subject  = 'Solicitu de soporte desde '.$data;
     ...
     $data = $tool->simple_db("select iva,popup_style,url_empresa from preferencias");      
    }
...
<div class="popup-titulo"><?=$_SESSION['CLIENTE_NOMBRE'] ?></div>
<div class="popup-instrucciones">
Escriba su pregunta y sus datos para solicitarnos soporte</div>
...
<form action="" method="post" name="form1" onSubmit="YY_checkform('form1','nombre','#q','0','Escriba su Nombre','email','S','2','Su dirección de email debe ser válida','pregunta','10','1','Por favor escriba su pregunta');return document.MM_returnValue">
   <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
    <td width="50%" class="popup-form-title">Solicitar Soporte</td>
    <td width="50%" class="nombre-de-producto"><?php echo 'Solicitud de Soporte'; ?>
    <input name="producto" type="hidden" id="producto" value="<?php echo 'Solicitud de Soporte'; ?>">
    </td>
    </tr>
    <tr>
